...
function _adminGetAnalytics() {
  ...
  return { revenue7d:revenue, orders7d:cnt, labels7d:labels, bySite:[{id:'parfum',rev:totalRevenue,orders:orders.length,conv:0}], totalOrders:orders.length, totalRevenue, ts:Date.now() };
}
